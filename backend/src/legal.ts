...
const pages = {
  privacy: {
    ...
    body: `
      ...
      <p>External AI is off until you give versioned consent. With active consent, Soniox may receive the complete video file, including its visual frames and audio, to transcribe the audio. Alibaba Cloud Qwen may receive transcript and visual-analysis text plus capture dates to create daily summaries. Mage-VL processing may retrieve consented video to produce visual analysis and requested derivatives. An MCP client or agent can retrieve only videos you separately enable. You can withdraw consent at any time; withdrawal stops new external-AI work and MCP access.</p>
