/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.test.jsonc ./src/worker-configuration.d.ts` (hash: a86fafe22b34f36944bb0dcc22b496d2)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "APPLE_BUNDLE_ID" | "SESSION_TTL_SECONDS" | "PLAYBACK_GRANT_TTL_SECONDS" | "SINGLE_UPLOAD_MAX_BYTES" | "MULTIPART_PART_SIZE_BYTES" | "QWENCLOUD_SUMMARY_BASE_URL" | "QWENCLOUD_SUMMARY_MODEL">> {}
}
