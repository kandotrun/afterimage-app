/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc ./src/worker-configuration.d.ts` (hash: ea479c3333bb98ad3b77c2bf0483ded3)
// Runtime types generated with workerd@1.20260722.1 2026-07-26 nodejs_compat
interface __BaseEnv_Env {
	MEDIA: R2Bucket;
	DB: D1Database;
	ENVIRONMENT: "production";
	APPLE_BUNDLE_ID: "com.kandotrun.afterimage";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "APPLE_BUNDLE_ID" | "SESSION_TTL_SECONDS" | "PLAYBACK_GRANT_TTL_SECONDS" | "SINGLE_UPLOAD_MAX_BYTES" | "MULTIPART_PART_SIZE_BYTES" | "SONIOX_MODEL" | "SONIOX_LANGUAGE_HINTS">> {}
}
