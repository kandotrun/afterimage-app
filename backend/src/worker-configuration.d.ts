/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.test.jsonc ./src/worker-configuration.d.ts` (hash: 31b865ce11385672430870a55e59be2d)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "APPLE_BUNDLE_ID" | "SESSION_TTL_SECONDS" | "PLAYBACK_GRANT_TTL_SECONDS" | "SINGLE_UPLOAD_MAX_BYTES" | "MULTIPART_PART_SIZE_BYTES">> {}
}
