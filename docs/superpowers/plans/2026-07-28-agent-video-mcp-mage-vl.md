...
**Files:**
- Create: `backend/migrations/0010_agent_video_access.sql`
...
```bash
git add backend/migrations/0010_agent_video_access.sql backend/src/app.ts backend/tests/app.test.ts
...
**Files:**
- Modify: `backend/migrations/0010_agent_video_access.sql`
...
```bash
git add backend/migrations/0010_agent_video_access.sql backend/src/env-secrets.d.ts backend/src/app.ts backend/src/gpu-jobs.ts backend/tests/app.test.ts
